...
alter table "public"."notifications" add constraint "fk_notifications_announcement" FOREIGN KEY (announcement_id) REFERENCES announcements(id) ON DELETE SET NULL not valid;

alter table "public"."notifications" validate constraint "fk_notifications_announcement";
