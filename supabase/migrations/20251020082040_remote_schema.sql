...
create type "public"."connection_status" as enum ('pending', 'accepted', 'blocked', 'ignored');

create type "public"."notification_type" as enum ('new_connection_request', 'connection_accepted', 'new_thread', 'new_space', 'system_update', 'new_reply', 'job_application_update');

drop trigger if exists "on_new_message_update_thread" on "public"."messages";

drop policy "Allow delete for owner" on "public"."courses_programs";

drop policy "Allow insert for owner" on "public"."courses_programs";

drop policy "Allow select for owner" on "public"."courses_programs";

drop policy "Allow update for owner" on "public"."courses_programs";

drop policy "Allow delete for owner" on "public"."medical_colleges";

drop policy "Allow insert for owner" on "public"."medical_colleges";

drop policy "Allow select for owner" on "public"."medical_colleges";

drop policy "Allow update for owner" on "public"."medical_colleges";

drop policy "Users can join/request to join spaces." on "public"."memberships";
...
drop policy "Allow authenticated read access to profiles" on "public"."profiles";

drop policy "Allow authenticated users to view all profiles" on "public"."profiles";

drop policy "Users can delete their own profile" on "public"."profiles";

drop policy "Users can update their own profile" on "public"."profiles";

drop policy "User connections delete for owner" on "public"."user_connections";

drop policy "User connections insert for owner" on "public"."user_connections";

drop policy "User connections select for owner" on "public"."user_connections";

drop policy "User connections update for owner" on "public"."user_connections";

drop policy "UserConnections: delete own" on "public"."user_connections";

drop policy "UserConnections: insert own" on "public"."user_connections";

drop policy "UserConnections: select related" on "public"."user_connections";

drop policy "UserConnections: update own" on "public"."user_connections";

drop policy "Users can create connection requests" on "public"."user_connections";

drop policy "Users can delete their connections" on "public"."user_connections";

drop policy "Users can update their connections" on "public"."user_connections";

drop policy "Users can view their connections" on "public"."user_connections";

drop policy "Allow message delete access" on "public"."messages";

drop policy "Allow message update access" on "public"."messages";

drop policy "Allow admins or creators to delete spaces" on "public"."spaces";

drop policy "Allow admins or creators to update spaces" on "public"."spaces";

revoke delete on table "public"."courses_programs" from "anon";

revoke insert on table "public"."courses_programs" from "anon";

revoke references on table "public"."courses_programs" from "anon";

revoke select on table "public"."courses_programs" from "anon";

revoke trigger on table "public"."courses_programs" from "anon";

revoke truncate on table "public"."courses_programs" from "anon";

revoke update on table "public"."courses_programs" from "anon";

revoke delete on table "public"."courses_programs" from "authenticated";

revoke insert on table "public"."courses_programs" from "authenticated";

revoke references on table "public"."courses_programs" from "authenticated";

revoke select on table "public"."courses_programs" from "authenticated";

revoke trigger on table "public"."courses_programs" from "authenticated";

revoke truncate on table "public"."courses_programs" from "authenticated";

revoke update on table "public"."courses_programs" from "authenticated";

revoke delete on table "public"."courses_programs" from "service_role";

revoke insert on table "public"."courses_programs" from "service_role";

revoke references on table "public"."courses_programs" from "service_role";

revoke select on table "public"."courses_programs" from "service_role";

revoke trigger on table "public"."courses_programs" from "service_role";

revoke truncate on table "public"."courses_programs" from "service_role";

revoke update on table "public"."courses_programs" from "service_role";
...
revoke select on table "public"."email_notifications" from "authenticated";
...
revoke delete on table "public"."email_notifications" from "service_role";

revoke insert on table "public"."email_notifications" from "service_role";

revoke references on table "public"."email_notifications" from "service_role";

revoke select on table "public"."email_notifications" from "service_role";

revoke trigger on table "public"."email_notifications" from "service_role";

revoke truncate on table "public"."email_notifications" from "service_role";

revoke update on table "public"."email_notifications" from "service_role";

revoke delete on table "public"."global_engagement" from "anon";

revoke insert on table "public"."global_engagement" from "anon";

revoke references on table "public"."global_engagement" from "anon";

revoke select on table "public"."global_engagement" from "anon";

revoke trigger on table "public"."global_engagement" from "anon";

revoke truncate on table "public"."global_engagement" from "anon";

revoke update on table "public"."global_engagement" from "anon";

revoke delete on table "public"."global_engagement" from "authenticated";

revoke insert on table "public"."global_engagement" from "authenticated";

revoke references on table "public"."global_engagement" from "authenticated";

revoke select on table "public"."global_engagement" from "authenticated";

revoke trigger on table "public"."global_engagement" from "authenticated";

revoke truncate on table "public"."global_engagement" from "authenticated";

revoke update on table "public"."global_engagement" from "authenticated";

revoke delete on table "public"."global_engagement" from "service_role";

revoke insert on table "public"."global_engagement" from "service_role";

revoke references on table "public"."global_engagement" from "service_role";

revoke select on table "public"."global_engagement" from "service_role";

revoke trigger on table "public"."global_engagement" from "service_role";

revoke truncate on table "public"."global_engagement" from "service_role";

revoke update on table "public"."global_engagement" from "service_role";
...
revoke delete on table "public"."job_postings" from "authenticated";

revoke insert on table "public"."job_postings" from "authenticated";

revoke references on table "public"."job_postings" from "authenticated";

revoke select on table "public"."job_postings" from "authenticated";

revoke trigger on table "public"."job_postings" from "authenticated";

revoke truncate on table "public"."job_postings" from "authenticated";

revoke update on table "public"."job_postings" from "authenticated";

revoke delete on table "public"."job_postings" from "service_role";

revoke insert on table "public"."job_postings" from "service_role";

revoke references on table "public"."job_postings" from "service_role";

revoke select on table "public"."job_postings" from "service_role";

revoke trigger on table "public"."job_postings" from "service_role";

revoke truncate on table "public"."job_postings" from "service_role";

revoke update on table "public"."job_postings" from "service_role";

revoke delete on table "public"."medical_colleges" from "anon";

revoke insert on table "public"."medical_colleges" from "anon";

revoke references on table "public"."medical_colleges" from "anon";

revoke select on table "public"."medical_colleges" from "anon";

revoke trigger on table "public"."medical_colleges" from "anon";

revoke truncate on table "public"."medical_colleges" from "anon";

revoke update on table "public"."medical_colleges" from "anon";

revoke delete on table "public"."medical_colleges" from "authenticated";

revoke insert on table "public"."medical_colleges" from "authenticated";

revoke references on table "public"."medical_colleges" from "authenticated";

revoke select on table "public"."medical_colleges" from "authenticated";

revoke trigger on table "public"."medical_colleges" from "authenticated";

revoke truncate on table "public"."medical_colleges" from "authenticated";

revoke update on table "public"."medical_colleges" from "authenticated";

revoke delete on table "public"."medical_colleges" from "service_role";

revoke insert on table "public"."medical_colleges" from "service_role";

revoke references on table "public"."medical_colleges" from "service_role";

revoke select on table "public"."medical_colleges" from "service_role";

revoke trigger on table "public"."medical_colleges" from "service_role";

revoke truncate on table "public"."medical_colleges" from "service_role";

revoke update on table "public"."medical_colleges" from "service_role";
...
revoke delete on table "public"."partner_services" from "anon";

revoke insert on table "public"."partner_services" from "anon";

revoke references on table "public"."partner_services" from "anon";

revoke select on table "public"."partner_services" from "anon";

revoke trigger on table "public"."partner_services" from "anon";

revoke truncate on table "public"."partner_services" from "anon";

revoke update on table "public"."partner_services" from "anon";

revoke delete on table "public"."partner_services" from "authenticated";

revoke insert on table "public"."partner_services" from "authenticated";

revoke references on table "public"."partner_services" from "authenticated";

revoke select on table "public"."partner_services" from "authenticated";

revoke trigger on table "public"."partner_services" from "authenticated";

revoke truncate on table "public"."partner_services" from "authenticated";

revoke update on table "public"."partner_services" from "authenticated";

revoke delete on table "public"."partner_services" from "service_role";

revoke insert on table "public"."partner_services" from "service_role";

revoke references on table "public"."partner_services" from "service_role";

revoke select on table "public"."partner_services" from "service_role";

revoke trigger on table "public"."partner_services" from "service_role";

revoke truncate on table "public"."partner_services" from "service_role";

revoke update on table "public"."partner_services" from "service_role";
...
revoke delete on table "public"."user_education" from "authenticated";

revoke insert on table "public"."user_education" from "authenticated";

revoke references on table "public"."user_education" from "authenticated";

revoke select on table "public"."user_education" from "authenticated";

revoke trigger on table "public"."user_education" from "authenticated";

revoke truncate on table "public"."user_education" from "authenticated";

revoke update on table "public"."user_education" from "authenticated";

revoke delete on table "public"."user_education" from "service_role";

revoke insert on table "public"."user_education" from "service_role";

revoke references on table "public"."user_education" from "service_role";

revoke select on table "public"."user_education" from "service_role";

revoke trigger on table "public"."user_education" from "service_role";

revoke truncate on table "public"."user_education" from "service_role";

revoke update on table "public"."user_education" from "service_role";

revoke delete on table "public"."user_professional_details" from "anon";

revoke insert on table "public"."user_professional_details" from "anon";

revoke references on table "public"."user_professional_details" from "anon";

revoke select on table "public"."user_professional_details" from "anon";

revoke trigger on table "public"."user_professional_details" from "anon";

revoke truncate on table "public"."user_professional_details" from "anon";

revoke update on table "public"."user_professional_details" from "anon";

revoke delete on table "public"."user_professional_details" from "authenticated";

revoke insert on table "public"."user_professional_details" from "authenticated";

revoke references on table "public"."user_professional_details" from "authenticated";

revoke select on table "public"."user_professional_details" from "authenticated";

revoke trigger on table "public"."user_professional_details" from "authenticated";

revoke truncate on table "public"."user_professional_details" from "authenticated";

revoke update on table "public"."user_professional_details" from "authenticated";

revoke delete on table "public"."user_professional_details" from "service_role";

revoke insert on table "public"."user_professional_details" from "service_role";

revoke references on table "public"."user_professional_details" from "service_role";

revoke select on table "public"."user_professional_details" from "service_role";

revoke trigger on table "public"."user_professional_details" from "service_role";

revoke truncate on table "public"."user_professional_details" from "service_role";

revoke update on table "public"."user_professional_details" from "service_role";

revoke delete on table "public"."user_recommendations" from "anon";

revoke insert on table "public"."user_recommendations" from "anon";

revoke references on table "public"."user_recommendations" from "anon";

revoke select on table "public"."user_recommendations" from "anon";

revoke trigger on table "public"."user_recommendations" from "anon";

revoke truncate on table "public"."user_recommendations" from "anon";

revoke update on table "public"."user_recommendations" from "anon";

revoke delete on table "public"."user_recommendations" from "authenticated";

revoke insert on table "public"."user_recommendations" from "authenticated";

revoke references on table "public"."user_recommendations" from "authenticated";

revoke select on table "public"."user_recommendations" from "authenticated";

revoke trigger on table "public"."user_recommendations" from "authenticated";

revoke truncate on table "public"."user_recommendations" from "authenticated";

revoke update on table "public"."user_recommendations" from "authenticated";

revoke delete on table "public"."user_recommendations" from "service_role";

revoke insert on table "public"."user_recommendations" from "service_role";

revoke references on table "public"."user_recommendations" from "service_role";

revoke select on table "public"."user_recommendations" from "service_role";

revoke trigger on table "public"."user_recommendations" from "service_role";

revoke truncate on table "public"."user_recommendations" from "service_role";

revoke update on table "public"."user_recommendations" from "service_role";
...
alter table "public"."courses_programs" drop constraint "courses_programs_name_key";

alter table "public"."medical_colleges" drop constraint "medical_colleges_name_key";

alter table "public"."user_connections" drop constraint "user_connections_status_check";

alter table "public"."user_education" drop constraint "user_education_college_id_fkey";

alter table "public"."user_education" drop constraint "user_education_course_id_fkey";

drop function if exists "public"."create_thread"(p_title text, p_body text, p_space_id uuid);

drop function if exists "public"."create_user_connection"(requester_id uuid, addressee_id uuid);

drop function if exists "public"."is_space_admin_or_creator"(space_id_to_check uuid);

drop function if exists "public"."is_space_moderator_or_admin"(space_id_to_check uuid);

drop function if exists "public"."is_thread_creator"(thread_id_to_check uuid);

drop function if exists "public"."request_to_join_space"(p_space_id uuid, p_space_type text);

drop function if exists "public"."get_pending_requests"(p_space_id uuid);

drop function if exists "public"."get_threads"(p_space_id uuid);

drop function if exists "public"."get_user_recommendations"(target_user_id uuid);

alter table "public"."courses_programs" drop constraint "courses_programs_pkey";

alter table "public"."medical_colleges" drop constraint "medical_colleges_pkey";

drop index if exists "public"."courses_programs_name_key";

drop index if exists "public"."courses_programs_pkey";

drop index if exists "public"."idx_courses_programs_created_by";

drop index if exists "public"."idx_medical_colleges_admin_id";

drop index if exists "public"."medical_colleges_name_key";

drop index if exists "public"."medical_colleges_pkey";

drop table "public"."courses_programs";

drop table "public"."medical_colleges";
...
alter table "public"."student_years" enable row level security;

alter table "public"."notification_preferences" drop column "message_notifications";

alter table "public"."profiles" drop column "course";

alter table "public"."profiles" drop column "current_location";

alter table "public"."profiles" drop column "institution";

alter table "public"."profiles" drop column "specialization";

alter table "public"."profiles" drop column "year_of_study";

alter table "public"."profiles" drop column "years_experience";

alter table "public"."profiles" add column "connection_count" integer not null default 0;

alter table "public"."profiles" add column "course_id" uuid;

alter table "public"."profiles" add column "course_other" text;

alter table "public"."profiles" add column "date_of_birth" date;

alter table "public"."profiles" add column "encrypted_user_master_key" text;

alter table "public"."profiles" add column "encryption_salt" text;

alter table "public"."profiles" add column "experience_level_value" text;

alter table "public"."profiles" add column "institution_id" uuid;

alter table "public"."profiles" add column "institution_other" text;

alter table "public"."profiles" add column "location_id" uuid;

alter table "public"."profiles" add column "location_other" text;

alter table "public"."profiles" add column "privacy_settings" jsonb default '{"bio": "public", "email": "connections", "phone": "connections", "course": "public", "institution": "public", "organization": "public", "date_of_birth": "private", "year_of_study": "connections", "specialization": "public", "medical_license": "private", "current_location": "public", "current_position": "public", "years_experience": "public"}'::jsonb;

alter table "public"."profiles" add column "role" text not null default 'USER'::text;

alter table "public"."profiles" add column "specialization_id" uuid;

alter table "public"."profiles" add column "specialization_other" text;

alter table "public"."profiles" add column "student_year_value" text;

alter table "public"."spaces" add column "updated_at" timestamp with time zone not null default now();

alter table "public"."user_connections" alter column "addressee_id" set not null;

alter table "public"."user_connections" alter column "created_at" set not null;

alter table "public"."user_connections" alter column "requester_id" set not null;

alter table "public"."user_connections" alter column "status" set default 'pending'::connection_status;

alter table "public"."user_connections" alter column "status" set not null;

alter table "public"."user_connections" alter column "status" set data type connection_status using "status"::connection_status;
...
CREATE INDEX courses_search_idx ON public.courses USING gin (value gin_trgm_ops, label gin_trgm_ops);

CREATE UNIQUE INDEX courses_value_key ON public.courses USING btree (value);

CREATE UNIQUE INDEX direct_message_attachments_pkey ON public.direct_message_attachments USING btree (id);

CREATE UNIQUE INDEX direct_message_reactions_message_id_user_id_key ON public.direct_message_reactions USING btree (message_id, user_id);

CREATE UNIQUE INDEX direct_message_reactions_pkey ON public.direct_message_reactions USING btree (id);

CREATE UNIQUE INDEX direct_messages_pkey ON public.direct_messages USING btree (id);

CREATE UNIQUE INDEX experience_levels_pkey ON public.experience_levels USING btree (value);

CREATE UNIQUE INDEX feedback_pkey ON public.feedback USING btree (id);

CREATE INDEX idx_profiles_course_id ON public.profiles USING btree (course_id);

CREATE INDEX idx_profiles_course_other ON public.profiles USING btree (course_other) WHERE (course_other IS NOT NULL);
...
CREATE INDEX idx_profiles_institution_other ON public.profiles USING btree (institution_other) WHERE (institution_other IS NOT NULL);

CREATE INDEX idx_profiles_location_id ON public.profiles USING btree (location_id);

CREATE INDEX idx_profiles_location_other ON public.profiles USING btree (location_other) WHERE (location_other IS NOT NULL);

CREATE INDEX idx_profiles_privacy_settings ON public.profiles USING gin (privacy_settings);

CREATE INDEX idx_profiles_specialization_id ON public.profiles USING btree (specialization_id);

CREATE INDEX idx_profiles_specialization_other ON public.profiles USING btree (specialization_other) WHERE (specialization_other IS NOT NULL);

CREATE UNIQUE INDEX institutions_pkey ON public.institutions USING btree (id);

CREATE INDEX institutions_search_idx ON public.institutions USING gin (value gin_trgm_ops, label gin_trgm_ops);

CREATE UNIQUE INDEX institutions_value_key ON public.institutions USING btree (value);

CREATE UNIQUE INDEX location_aliases_pkey ON public.location_aliases USING btree (alias);

CREATE UNIQUE INDEX locations_pkey ON public.locations USING btree (id);

CREATE INDEX locations_search_idx ON public.locations USING gin (value gin_trgm_ops, label gin_trgm_ops);

CREATE UNIQUE INDEX locations_value_key ON public.locations USING btree (value);

CREATE UNIQUE INDEX notifications_pkey ON public.notifications USING btree (id);

CREATE UNIQUE INDEX partnership_proposals_pkey ON public.partnership_proposals USING btree (id);

CREATE UNIQUE INDEX specializations_pkey ON public.specializations USING btree (id);

CREATE INDEX specializations_search_idx ON public.specializations USING gin (value gin_trgm_ops, label gin_trgm_ops);

CREATE UNIQUE INDEX specializations_value_key ON public.specializations USING btree (value);

CREATE UNIQUE INDEX student_years_pkey ON public.student_years USING btree (value);
...
alter table "public"."direct_message_attachments" add constraint "direct_message_attachments_pkey" PRIMARY KEY using index "direct_message_attachments_pkey";

alter table "public"."direct_message_reactions" add constraint "direct_message_reactions_pkey" PRIMARY KEY using index "direct_message_reactions_pkey";

alter table "public"."direct_messages" add constraint "direct_messages_pkey" PRIMARY KEY using index "direct_messages_pkey";

alter table "public"."experience_levels" add constraint "experience_levels_pkey" PRIMARY KEY using index "experience_levels_pkey";
...
alter table "public"."location_aliases" add constraint "location_aliases_pkey" PRIMARY KEY using index "location_aliases_pkey";

alter table "public"."locations" add constraint "locations_pkey" PRIMARY KEY using index "locations_pkey";

alter table "public"."notifications" add constraint "notifications_pkey" PRIMARY KEY using index "notifications_pkey";

alter table "public"."partnership_proposals" add constraint "partnership_proposals_pkey" PRIMARY KEY using index "partnership_proposals_pkey";

alter table "public"."specializations" add constraint "specializations_pkey" PRIMARY KEY using index "specializations_pkey";

alter table "public"."student_years" add constraint "student_years_pkey" PRIMARY KEY using index "student_years_pkey";
...
alter table "public"."courses" add constraint "courses_value_key" UNIQUE using index "courses_value_key";

alter table "public"."direct_message_attachments" add constraint "direct_message_attachments_message_id_fkey" FOREIGN KEY (message_id) REFERENCES direct_messages(id) ON DELETE CASCADE not valid;

alter table "public"."direct_message_attachments" validate constraint "direct_message_attachments_message_id_fkey";

alter table "public"."direct_message_attachments" add constraint "direct_message_attachments_uploaded_by_fkey" FOREIGN KEY (uploaded_by) REFERENCES profiles(id) ON DELETE CASCADE not valid;

alter table "public"."direct_message_attachments" validate constraint "direct_message_attachments_uploaded_by_fkey";

alter table "public"."direct_message_reactions" add constraint "direct_message_reactions_message_id_fkey" FOREIGN KEY (message_id) REFERENCES direct_messages(id) ON DELETE CASCADE not valid;

alter table "public"."direct_message_reactions" validate constraint "direct_message_reactions_message_id_fkey";

alter table "public"."direct_message_reactions" add constraint "direct_message_reactions_message_id_user_id_key" UNIQUE using index "direct_message_reactions_message_id_user_id_key";

alter table "public"."direct_message_reactions" add constraint "direct_message_reactions_reaction_emoji_check" CHECK (((char_length(reaction_emoji) > 0) AND (char_length(reaction_emoji) < 5))) not valid;

alter table "public"."direct_message_reactions" validate constraint "direct_message_reactions_reaction_emoji_check";

alter table "public"."direct_message_reactions" add constraint "direct_message_reactions_user_id_fkey" FOREIGN KEY (user_id) REFERENCES profiles(id) ON DELETE CASCADE not valid;

alter table "public"."direct_message_reactions" validate constraint "direct_message_reactions_user_id_fkey";

alter table "public"."direct_messages" add constraint "direct_messages_content_check" CHECK ((char_length(content) > 0)) not valid;

alter table "public"."direct_messages" validate constraint "direct_messages_content_check";

alter table "public"."direct_messages" add constraint "direct_messages_conversation_id_fkey" FOREIGN KEY (conversation_id) REFERENCES conversations(id) ON DELETE CASCADE not valid;

alter table "public"."direct_messages" validate constraint "direct_messages_conversation_id_fkey";

alter table "public"."direct_messages" add constraint "direct_messages_parent_message_id_fkey" FOREIGN KEY (parent_message_id) REFERENCES direct_messages(id) ON DELETE SET NULL not valid;

alter table "public"."direct_messages" validate constraint "direct_messages_parent_message_id_fkey";

alter table "public"."direct_messages" add constraint "direct_messages_sender_id_fkey" FOREIGN KEY (sender_id) REFERENCES profiles(id) ON DELETE CASCADE not valid;

alter table "public"."direct_messages" validate constraint "direct_messages_sender_id_fkey";

alter table "public"."feedback" add constraint "feedback_category_check" CHECK ((category = ANY (ARRAY['general'::text, 'feature-request'::text, 'bug-report'::text, 'appreciation'::text, 'forum-feedback'::text, 'networking-feedback'::text, 'ui-ux'::text, 'performance'::text, 'other'::text]))) not valid;

alter table "public"."feedback" validate constraint "feedback_category_check";

alter table "public"."feedback" add constraint "feedback_description_check" CHECK ((char_length(description) > 10)) not valid;

alter table "public"."feedback" validate constraint "feedback_description_check";
...
alter table "public"."feedback" add constraint "feedback_status_check" CHECK ((status = ANY (ARRAY['new'::text, 'viewed'::text, 'in-progress'::text, 'resolved'::text]))) not valid;

alter table "public"."feedback" validate constraint "feedback_status_check";

alter table "public"."feedback" add constraint "feedback_subject_check" CHECK ((char_length(subject) > 3)) not valid;

alter table "public"."feedback" validate constraint "feedback_subject_check";
...
alter table "public"."institutions" add constraint "institutions_value_key" UNIQUE using index "institutions_value_key";

alter table "public"."location_aliases" add constraint "location_aliases_location_id_fkey" FOREIGN KEY (location_id) REFERENCES locations(id) not valid;

alter table "public"."location_aliases" validate constraint "location_aliases_location_id_fkey";

alter table "public"."locations" add constraint "locations_value_key" UNIQUE using index "locations_value_key";

alter table "public"."notifications" add constraint "notifications_actor_id_fkey" FOREIGN KEY (actor_id) REFERENCES profiles(id) ON DELETE CASCADE not valid;
...
alter table "public"."partnership_proposals" add constraint "validate_email" CHECK ((email ~* '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$'::text)) not valid;

alter table "public"."partnership_proposals" validate constraint "validate_email";

alter table "public"."partnership_proposals" add constraint "validate_website" CHECK (((website IS NULL) OR (website ~* '^https?://[^\s/$.?#].[^\s]*$'::text))) not valid;

alter table "public"."partnership_proposals" validate constraint "validate_website";

alter table "public"."profiles" add constraint "fk_profiles_experience_level" FOREIGN KEY (experience_level_value) REFERENCES experience_levels(value) ON UPDATE CASCADE ON DELETE SET NULL not valid;

alter table "public"."profiles" validate constraint "fk_profiles_experience_level";

alter table "public"."profiles" add constraint "fk_profiles_student_year" FOREIGN KEY (student_year_value) REFERENCES student_years(value) ON UPDATE CASCADE ON DELETE SET NULL not valid;

alter table "public"."profiles" validate constraint "fk_profiles_student_year";

alter table "public"."profiles" add constraint "profiles_course_id_fkey" FOREIGN KEY (course_id) REFERENCES courses(id) not valid;

alter table "public"."profiles" validate constraint "profiles_course_id_fkey";

alter table "public"."profiles" add constraint "profiles_institution_id_fkey" FOREIGN KEY (institution_id) REFERENCES institutions(id) not valid;

alter table "public"."profiles" validate constraint "profiles_institution_id_fkey";

alter table "public"."profiles" add constraint "profiles_location_id_fkey" FOREIGN KEY (location_id) REFERENCES locations(id) not valid;

alter table "public"."profiles" validate constraint "profiles_location_id_fkey";

alter table "public"."profiles" add constraint "profiles_specialization_id_fkey" FOREIGN KEY (specialization_id) REFERENCES specializations(id) not valid;

alter table "public"."profiles" validate constraint "profiles_specialization_id_fkey";

alter table "public"."specializations" add constraint "specializations_value_key" UNIQUE using index "specializations_value_key";

alter table "public"."user_connections" add constraint "check_requester_not_addressee" CHECK ((requester_id <> addressee_id)) not valid;

alter table "public"."user_connections" validate constraint "check_requester_not_addressee";

alter table "public"."user_connections" add constraint "fk_addressee" FOREIGN KEY (addressee_id) REFERENCES profiles(id) ON DELETE CASCADE not valid;

alter table "public"."user_connections" validate constraint "fk_addressee";

alter table "public"."user_connections" add constraint "fk_requester" FOREIGN KEY (requester_id) REFERENCES profiles(id) ON DELETE CASCADE not valid;

alter table "public"."user_connections" validate constraint "fk_requester";
...
BEGIN
  ...
  IF NOT COALESCE(is_admin, FALSE) THEN
    RAISE EXCEPTION 'Only space admins can delete a space.';
  END IF;
...
BEGIN
  ...
  SELECT (public.is_thread_creator(p_thread_id, p_user_id) OR 
          public.is_space_moderator_or_admin(v_space_id, auth.uid()))
  INTO v_can_delete;
...
create or replace view "public"."inbox_conversations" as  WITH ranked_messages AS (
         SELECT direct_messages.conversation_id,
            direct_messages.content,
            direct_messages.sender_id,
            direct_messages.created_at,
            row_number() OVER (PARTITION BY direct_messages.conversation_id ORDER BY direct_messages.created_at DESC) AS rn
 ...
 SELECT p.conversation_id,
    ...
    ( SELECT count(*) AS count
          ...
          WHERE ((dm.conversation_id = p.conversation_id) AND (dm.is_read = false) AND (dm.sender_id <> auth.uid()))) AS unread_count,
    c.updated_at,
    c.master_encryption_key,
    p.encrypted_conversation_key
   FROM ((((conversation_participants p
     JOIN conversation_participants other_p ON (((p.conversation_id = other_p.conversation_id) AND (p.user_id <> other_p.user_id))))
     JOIN profiles other_user ON ((other_p.user_id = other_user.id)))
     JOIN conversations c ON ((p.conversation_id = c.id)))
     LEFT JOIN ranked_messages last_msg ON (((p.conversation_id = last_msg.conversation_id) AND (last_msg.rn = 1))))
...
BEGIN
  DELETE FROM public.user_connections
  WHERE
    status = 'accepted'::public.connection_status AND
...
AS $function$BEGIN
    ...
    VALUES (
        NEW.id,
        true,  -- Default: Get connection request alerts
        true,  -- Default: Get job alerts
        true,  -- Default: Get forum updates
        true
    );
    RETURN NEW;
END;$function$
...
CREATE OR REPLACE FUNCTION public.get_user_recommendations(target_user_id uuid)
 RETURNS TABLE(id uuid, full_name text, current_location text, specialization text, years_experience text, institution text, course text, organization text, similarity_score numeric)
 LANGUAGE plpgsql
AS $function$
BEGIN
  RETURN QUERY
...
create policy "Users can manage and view their own participation"
...
create policy "Allow conversation participants to view attachments"
on "public"."direct_message_attachments"
as permissive
for select
to authenticated
using ((EXISTS ( SELECT 1
  ...
  WHERE ((dm.id = direct_message_attachments.message_id) AND (cp.user_id = auth.uid())))));
...
create policy "Allow access to reactions within a conversation"
on "public"."direct_message_reactions"
as permissive
for select
to public
using ((message_id IN ( SELECT direct_messages.id
   FROM direct_messages
  WHERE (direct_messages.conversation_id IN ( SELECT conversation_participants.conversation_id
           FROM conversation_participants
          WHERE (conversation_participants.user_id = auth.uid()))))));
...
create policy "Allow participant to update message status"
...
create policy "Managers can remove members from their space"
on "public"."memberships"
as permissive
for delete
to public
using (is_space_moderator_or_admin(space_id, auth.uid()));


create policy "Managers can update memberships in their space"
on "public"."memberships"
as permissive
for update
to public
using (is_space_moderator_or_admin(space_id, auth.uid()))
with check (is_space_moderator_or_admin(space_id, auth.uid()));
...
create policy "Block all direct DELETEs."
...
create policy "Block all direct INSERTs."
on "public"."notification_preferences"
as permissive
for insert
to public
...
create policy "Addressees can respond to pending requests"
on "public"."user_connections"
as permissive
for update
to public
using (((auth.uid() = addressee_id) AND (status = 'pending'::connection_status)))
with check ((status = ANY (ARRAY['accepted'::connection_status, 'ignored'::connection_status])));


create policy "Users can remove their accepted connections"
on "public"."user_connections"
as permissive
for delete
to public
using ((((auth.uid() = requester_id) OR (auth.uid() = addressee_id)) AND (status = 'accepted'::connection_status)));
...
create policy "Users can view their own connections and own blocklist"
on "public"."user_connections"
as permissive
for select
to public
using (((((auth.uid() = requester_id) OR (auth.uid() = addressee_id)) AND (status <> 'blocked'::connection_status)) OR ((status = 'blocked'::connection_status) AND (auth.uid() = requester_id))));


create policy "Allow message delete access"
on "public"."messages"
as permissive
for delete
to public
using (is_space_moderator_or_admin(( SELECT threads.space_id
   FROM threads
  WHERE (threads.id = messages.thread_id)), auth.uid()));


create policy "Allow message update access"
on "public"."messages"
as permissive
for update
to public
using (is_space_moderator_or_admin(( SELECT threads.space_id
   FROM threads
  WHERE (threads.id = messages.thread_id)), auth.uid()))
with check (is_space_moderator_or_admin(( SELECT threads.space_id
   FROM threads
  WHERE (threads.id = messages.thread_id)), auth.uid()));


create policy "Allow admins or creators to delete spaces"
on "public"."spaces"
as permissive
for delete
to public
using (is_space_moderator_or_admin(id, auth.uid()));


create policy "Allow admins or creators to update spaces"
on "public"."spaces"
as permissive
for update
to public
using (is_space_moderator_or_admin(id, auth.uid()))
with check (is_space_moderator_or_admin(id, auth.uid()));


CREATE TRIGGER on_message_edit BEFORE UPDATE ON public.direct_messages FOR EACH ROW EXECUTE FUNCTION set_message_updated_at();

CREATE TRIGGER on_new_direct_message AFTER INSERT ON public.direct_messages FOR EACH ROW EXECUTE FUNCTION update_conversation_timestamp();

CREATE TRIGGER on_new_reply AFTER INSERT ON public.messages FOR EACH ROW EXECUTE FUNCTION handle_new_reply();

CREATE TRIGGER trigger_update_thread_metrics_on_delete AFTER DELETE ON public.messages FOR EACH ROW EXECUTE FUNCTION update_thread_metrics_on_delete_message();

CREATE TRIGGER trigger_clean_profile_fields BEFORE INSERT OR UPDATE ON public.profiles FOR EACH ROW EXECUTE FUNCTION clean_profile_normalized_fields();

CREATE TRIGGER on_new_public_space AFTER INSERT ON public.spaces FOR EACH ROW EXECUTE FUNCTION handle_new_public_space();

CREATE TRIGGER on_space_created_assign_creator_role AFTER INSERT ON public.spaces FOR EACH ROW EXECUTE FUNCTION assign_creator_role_on_space_creation();

CREATE TRIGGER set_spaces_updated_at BEFORE UPDATE ON public.spaces FOR EACH ROW EXECUTE FUNCTION set_updated_at_timestamp();

CREATE TRIGGER on_new_public_thread AFTER INSERT ON public.threads FOR EACH ROW EXECUTE FUNCTION handle_new_public_thread();

CREATE TRIGGER on_accept_cleanup_reciprocal BEFORE UPDATE ON public.user_connections FOR EACH ROW EXECUTE FUNCTION handle_reciprocal_request();

CREATE TRIGGER on_connection_change_notify AFTER INSERT OR UPDATE ON public.user_connections FOR EACH ROW EXECUTE FUNCTION create_connection_notification();

CREATE TRIGGER on_connection_change_update_count AFTER DELETE OR UPDATE ON public.user_connections FOR EACH ROW EXECUTE FUNCTION update_connection_count();

CREATE TRIGGER on_user_connections_update BEFORE UPDATE ON public.user_connections FOR EACH ROW EXECUTE FUNCTION handle_updated_at();


CREATE TRIGGER on_auth_user_created AFTER INSERT ON auth.users FOR EACH ROW EXECUTE FUNCTION handle_new_user();

CREATE TRIGGER on_auth_user_created_create_notification_preferences AFTER INSERT ON auth.users FOR EACH ROW EXECUTE FUNCTION create_notification_preferences();

CREATE TRIGGER on_user_email_confirmed AFTER UPDATE OF email_confirmed_at ON auth.users FOR EACH ROW WHEN (((old.email_confirmed_at IS NULL) AND (new.email_confirmed_at IS NOT NULL))) EXECUTE FUNCTION handle_email_confirmation();


  create policy "Allow anonymous uploads to the public avatars folder"
  on "storage"."objects"
  as permissive
  for insert
  to anon
with check (((bucket_id = 'avatars'::text) AND ((storage.foldername(name))[1] = 'public'::text)));
  ...
  for insert
  to authenticated
with check ((bucket_id = 'direct_message_attachments'::text));
...
with check (((bucket_id = 'avatars'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));
  ...
  create policy "Allow owner to view attachments"
  on "storage"."objects"
  as permissive
  for select
  to authenticated
