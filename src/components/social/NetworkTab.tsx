    ...
    <Card>
      ...
      <CardContent className="space-y-2 max-h-[60vh] overflow-y-auto">
        {loading ? <Skeleton className="h-20 w-full" /> : filteredConnections.map(conn => {
          // --- Get LIVE follow status inside the map ---
          ...
          return (
            ...
            >
              ...
              <Button
                 ...
                 onClick={() => handleFollow(conn.id)} // Use local handler
              ...
              {/* Remove Button */}
              <Button variant="outline" size="sm" onClick={() => onRemoveConnection(conn.id)}> {/* Use prop function */}
